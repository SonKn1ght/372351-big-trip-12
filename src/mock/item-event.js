...
//   let availableOffers = () => {
//     const result = Offers.filter((current) => {
//       return current.type === pointType;
//     });
//     return result[0];
//   };
//
...
//   const quantityOffers = getRandomInteger(1, availableOffers().offers.length);
//
...
//   // console.log(availableOffers().offers.slice(0, quantityOffers));
//   return availableOffers().offers.slice(0, quantityOffers);
// };
//
